...
class Threads:
    ...
    def __init__(self, config: Config, logger: Logger):
        ...
        if process.returncode != 0:
            ...
            self.logger.info(Message(title=f"Playwright installation successful - Time: {datetime.fromtimestamp(int(time.time()), tz=pytz.timezone('America/Chicago'))}", body=msg), False)
