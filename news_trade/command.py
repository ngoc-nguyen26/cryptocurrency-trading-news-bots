...
class Command:
    ...
    async def error(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        self.logger.error(Message(f"Exception while handling an update:, exc_info={context.error}"))
        ...
        await context.bot.send_message(
            chat_id=self.config.TELEGRAM_PEER_ID, text=message, parse_mode=ParseMode.HTML
        )
